...
class IPUTrainer:
    ...
    def _inner_training_loop(
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                #print('step', step, 'self._maybe_log_save_evaluate(tr_loss, self.training_model, epoch, ignore_keys_for_eval)')   #wu
            ...
            #self._maybe_log_save_evaluate(tr_loss, self.training_model, epoch, ignore_keys_for_eval)        #wu, commented
            #wu
            print('epoch', epoch, 'self._maybe_log_save_evaluate(tr_loss, self.training_model, epoch, ignore_keys_for_eval)')
            print('self.control.should_evaluate', self.control.should_evaluate)
    ...
    def compute_loss(self, model, inputs, return_outputs=False):
        ...
        if labels is not None:
            ...
            # self.step += 1
            # import pdb
            # if self.step < 10: pdb.set_trace()
            # # loss = outputs[0]         # ok
            # loss = outputs["loss"]      # ok
